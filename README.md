This repository contains python/html code for an app named xplorny. The app uses data from several public databases from the New York City open data website (https://data.cityofnewyork.us).
